...
export default function JoinCard({ Data }) {
    return (
        <div className="shadow-md md:w-[32%] w-full  rounded-xl px-3 md:px-6 py-5  bg-white">
            {Data.Num == 1 && <div className=" pl-1 py-1 font-medium md:top-[-10px] md:left-[-10px]  w-10 h-10 bg-[linear-gradient(95.64deg,_#0076CE_0%,_#9400D3_100%);] -m-6 rounded text-white"> {Data.Num}<sup>st</sup></div>}
            ...
            <h1 className="w-full text-sm font-bold text-center md:text-xl "
            >{Data.MainHead}</h1>
