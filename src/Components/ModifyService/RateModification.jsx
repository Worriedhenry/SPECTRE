...
const RateModifiation = () => {
    ...
    const onSubmit = async (e) => {
        ...
        const res = await axios.post("http://localhost:3001/services/create", { serviceName, serviceBrief, serviceTags: [...tags], complexity, workSamples, serviceCost, serviceCostDuration, serviceCostCurrency, serviceDeadline, userToken })
    ...
    useEffect(() => {
        ...
        if (searchParams.get("create") !== "true") {
            ...
            axios
                .get("http://localhost:3001/services/getfullservice/" + serviceId)
                .then(res => {
    ...
    const updateService = async () => {
        const res = await axios.put("http://localhost:3001/services/updateservice/" + serviceId, { serviceId, serviceName, serviceBrief, serviceTags:[...tags], complexity, workSamples, serviceCost, serviceCostDuration, serviceCostCurrency, serviceDeadline })
        if(res.status==204){
    ...
    const deleteService= async ()=>{
        const res = await axios.delete("http://localhost:3001/services/deleteservice/" + serviceId)
        if(res.status==204){
